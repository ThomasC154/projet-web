        ...
        <form method="POST" action="{{ url('comments') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">Entrez votre nom ici:</label>
                ...
                <div class="form-group">
                    <label for="message">Entrez votre email ici:</label>
            ...
            <button type="submit" class="btn btn-sm btn-outline-success text-uppercase">soumettre</button>
        </form>
    </div>
</div>
<br />